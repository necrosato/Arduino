...
IPAddress gateway(6,6,6,2);         // this node's ap default router
IPAddress sta_ip(6,6,6,2);          // this node's station ip
IPAddress sta_gateway(6,6,6,1);     // this node's station default router
IPAddress subnet(255,255,255,0);    // subnet mask, this node's ap subnet address: 6.6.6.0, broadcast: 6.6.6.255

IPAddress other(6,6,6,1);
